export default {
  ...
  affable: {
    category: "Basic I",
    meaning: {
      meaning: "likeable; easy to talk to",
      sentence:
  ...
  apposite: {
    category: "Advanced IV",
    meaning: {
      meaning: "remarkably appropriate",
      sentence:
  ...
  appurtenant: {
    category: "Advanced V",
    meaning: {
      meaning: "supplying added support",
      sentence:
  ...
  autonomously: {
    category: "Basic III",
    meaning: {
      meaning: "Acting independently; self-governing (of a country)",
      sentence:
  ...
  base: {
    category: "Advanced I",
    meaning: {
      meaning: "the lowest, without any moral principles",
      sentence:
  ...
  bridle: {
    ...
    meaning: [
      ...
      {
        meaning: "to react with anger or to take offense",
        sentence:
  ...
  censor: {
    ...
    meaning: [
      {
        meaning: "an official who censors material",
        sentence:
  ...
  chary: {
    category: "Advanced I",
    meaning: {
      meaning: "cautious, suspiciously reluctant to do something",
      sentence:
  ...
  checkered: {
    category: "Basic II",
    meaning: {
      meaning: "marked by disreputable or unfortunate happenings",
      sentence:
  ...
  chortle: {
    category: "Common II",
    meaning: {
      meaning: "to chuckle, laugh merrily, often in a breathy, muffled way",
      sentence:
  ...
  confound: {
    ...
    meaning: [
      ...
      },
      {
        ...
        sentence: "Though Harry loved numbers, calculus confounded him.",
        type: "verb"
      }
    ]
  },
  ...
  contingent: {
    ...
    meaning: [
      ...
      {
        meaning: "dependent on (usually used with upon)",
        sentence:
  ...
  defray: {
    category: "Advanced I",
    meaning: {
      meaning: "to help pay the cost of, either in part or full",
      sentence:
  ...
  eccentric: {
    category: "Basic VI",
    meaning: {
      meaning: "highly unconventional or unusual (usually describes a person)",
      sentence:
  ...
  extant: {
    category: "Common I",
    meaning: {
      meaning: "still in existence (usually refers to documents).",
      sentence:
  ...
  lassitude: {
    category: "Basic II",
    meaning: {
      meaning: "extreme tiredness, either mental or physical",
      sentence:
  ...
  nonchalant: {
    category: "Advanced IV",
    meaning: {
      meaning: "coming across as uninterested or unconcerned; overly casual",
      sentence:
  ...
  panache: {
    category: "Common III",
    meaning: {
      meaning: "distinctive and showy elegance",
      sentence:
  ...
  profligate: {
    ...
    meaning: [
      {
        meaning: "someone who spends resources recklessly or wastefully",
        sentence:
      ...
      {
        meaning: "spending resources recklessly or wastefully",
        sentence:
  ...
  proselytize: {
    ...
    meaning: {
      meaning:
        "convert (someone) to another religion, philosophy, or perspective",
      sentence:
  ...
  quip: {
    ...
    meaning: [
      ...
      {
        meaning: "to make a witty remark, to say in jest",
        sentence:
  ...
  remiss: {
    category: "Basic I",
    meaning: {
      meaning: "to be negligent in one’s duty",
      sentence:
  ...
  reprobate: {
    category: "Basic I",
    meaning: {
      meaning: "a person without morals who is disapproved of",
      sentence:
  ...
  reticent: {
    category: "Common II",
    meaning: {
      meaning: "disinclined to talk, not revealing one's thoughts",
      sentence:
  ...
  subversive: {
    category: "Common V",
    meaning: {
      meaning: "in opposition to an established system or institution.",
      sentence:
  ...
  tout: {
    category: "Basic V",
    meaning: {
      meaning: "advertize in strongly positive terms; show off",
      sentence:
